...
export function Iphone({ backgroundColor = 'black', imageUrl }: IphoneProps) {
	return (
		...
		>
			<div
				className={`relative z-30 h-[868px] w-[428px] rounded-[68px] border border-[#1B1721] ${backgroundColor} p-[19px] shadow-[inset_0_0_4px_2px_rgb(192,183,205),inset_0_0_0_6px_rgb(52,44,63)]`}
			>
