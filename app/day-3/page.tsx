				...
				{!showFinal ? (
					...
					>
						...
						<motion.div
							...
							onClick={handlePrev}
						>
							<div className='text-white/80 text-2xl cursor-none select-none transition-colors duration-300 group-hover:text-white'>
								←
							</div>
						</motion.div>
						...
						>
							...
							<BlurText className='inline-block ml-2 text-white' delay={!isLoading ? 0.3 : 0}>
