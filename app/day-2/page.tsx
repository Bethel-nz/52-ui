...
const sections = [
	{
		...
		description:
			'Building digital products with a focus on motion and interaction. Every animation serves a purpose.',
	},
	{
		gradient: {
			from: '#2c2c2c',
		...
		description:
			'Crafting user interfaces that blend aesthetics with functionality. Simple, yet thoughtfully detailed.',
	},
	{
		gradient: {
			from: '#000000',
	...
	},
	{
		...
		description:
			'Exploring the boundaries between code and design. Where creativity meets technology.',
	},
];
				...
				<div className='min-h-fit px-16 py-24 max-w-6xl mx-auto relative'>
					<div className='flex'>
						<div className='flex gap-x-16 items-start'>
							...
							<div
								className='relative w-[400px] h-[300px] group'
								data-blobity='true'
							...
							<div className='flex flex-col justify-between h-[250px] max-w-xl'>
								...
								<div className='space-y-6'>
									<BlurText className='text-4xl font-medium tracking-tight'>
										Hi, I&apos;m <span className='text-gray-800'>Alex</span> - <span>Kepler</span>
									</BlurText>

									<BlurText className='text-xl text-gray-600' delay={0.1}>
										Software engineer and designer crafting interfaces with meticulous attention to
										detail.
									</BlurText>

									<BlurText className='text-lg text-gray-500' delay={0.2}>
										Currently building user experiences at{' '}
										<a
											className='text-semibold text-gray-900 hover:text-black'
										...
										, previously at{' '}
										<a
											className='text-semibold text-gray-900 hover:text-purple-800'
											data-blobity='true'
											data-blobity-magnetic='true'
											data-blobity-radius='4'
								...
								{/* Bottom Info */}
								<div className='mt-5'>
									<BlurText className='text-sm text-gray-400 flex items-center gap-x-2' delay={0.6}>
			...
			>
				<div className='w-full px-16 py-24'>
					<div className='max-w-6xl mx-auto space-y-[12vh]'>
						<BlurText className='text-2xl font-medium text-center'>Projects</BlurText>
			...
			<TrackedSection sectionId={2} className='min-h-[50vh]'>
				<div className='w-full px-16 py-24'>
					<div className='max-w-6xl mx-auto text-center space-y-6'>
						...
						>
							<a
								href='mailto:alex.kepler@mail.box'
